...
//         {/* form */}
//         <form onClick={onSubmitHandler} action="">
//           {/* username */}
//           <div>
...
//             onChange={(e) => setUser({...user, password: e.target.value})}   className='w-full input input-bordered h-8' placeholder='Enter Your Password'/>
//           </div>
